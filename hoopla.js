...
let formData = {
  form:{
    loginUrl:'/reports/dashboard',
    username:logins.hoopla.un,
    password:logins.hoopla.pw,
    login:''
  }
};
const hooplaDate = {
...
request(options,'https://library-admin.hoopladigital.com/login', function (error, response, html) {
